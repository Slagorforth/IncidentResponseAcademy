 ...
 * [Patch Management] Was ist Patch Management?
    Patch Management bezieht sich auf den Prozess, bei dem Software-Updates, Patches und Fixes auf Computersystemen und Anwendungen installiert werden. Ein Patch (deutsch Flicken) stopft die Sicherheitslücke, behebt Programmfehler und verhindert so den Erfolg von Malware-Angriffen.
 ...
 * [Asset Management] Was ist Asset Management?
    Im IT-Bereich bezieht sich Asset Management auf den Prozess des Verwalten von IT-Systemen und -Geräten, einschließlich Computer, Netzwerke, Software und anderer IT-Ressourcen. Es umfasst die Überwachung und Verwaltung dieser Ressourcen, um sicherzustellen, dass sie effektiv und effizient genutzt werden.
        **[Mehr erfahren] Worauf muss man beim Asset Management achten?
            Es ist wichtig, eine vollständige und aktuelle Liste aller IT-Assets zu haben und diese regelmäßig zu überwachen, um sicherzustellen, dass keine Systeme oder Geräte übersehen werden und ordnungsgemäß funktionieren. Außerdem muss der Lebenszyklus der Geräte regelmäßig geprüft werden, um sie rechtzeitig auszutauschen.
                ***[Zurück]-> Divert1
        **[Zurück] -> Divert1
 * [Active Directory] Was ist ein Active Directory?
    Active Directory ist ein Verzeichnisdienst für Windows Netzwerken und ermöglicht IT-Ressourcen zu verwalten und zu organisieren. Es unterstützt die Verwaltung von Benutzerkonten, Computer, Geräten und Anwendungen in einer zentralen Datenbank.
 ...
 * [Netzwerk] Was ist ein Netzwerk?
    Ein Netzwerk ist eine Ansammlung von Computern, Geräten und Systemen, die miteinander verbunden sind, um Informationen und Ressourcen zu teilen.
        **[Komponenten] Worauf besteht ein Netzwerk?
            Ein Netzwerk besteht aus Geräten (Computer, Laptops, Drucker etc.), Netzwerkschnittstellen, Netzwerkmedien (Kabel, Funkwellen), Anwendungen und Dienste und Netzwerkschicht-Protokolle. Letztere beinhalten Regeln und Verfahren, die es Geräten ermöglichen, miteinander zu kommunizieren und Daten zu übertragen.
                ***[Zurück]-> Divert1
        **[Zurück] -> Divert1         
...
* [White List] Was ist eine White List?
    White Listing ist eine Methode zur Überwachung und Kontrolle von Netzwerk- und Systemzugriffen, bei der nur genehmigte Anwendungen und Dateien ausgeführt werden dürfen.
        **[Mehr erfahren] Worauf muss man bei einer White List achten?
            Bei einer White List muss der Zugriff auf unbekannte Anwendungen und Dateien überwacht und die Ausführung blockiert werden, wenn sie als gefährlich eingestuft werden. Es können Tools oder Ähnliches implementiert werden, die über mögliche Bedrohungen informiert und bei der Reaktion auf diese Bedrohungen unterstützt.
                ***[Zurück]-> Divert1
        **[Zurück]-> Divert1         
* [Leave] ->EndPart
