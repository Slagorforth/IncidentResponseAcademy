 ...
 * [Phishing] Erzähl mir mehr über Phishing.
    Phishing sind Attacken Versuche, vertrauliche Informationen wie Passwörter oder Kreditkartendetails durch gefälschte E-Mails oder Websites zu stehlen.
 ...
 * [Malware] Erzähl mir mehr über Malware.
    Die Verbreitung von Schadsoftware wie Viren, Trojaner oder Würmer, die dazu verwendet werden, Daten zu stehlen oder Systeme zu beschädigen.
        **[Beispiele] Wie funktioniert das genau?
            Die Schadsoftware wird oft über E-Mail-Anhänge, gefälschte Downloads oder infizierte Websites verbreitet. Einfallstore sind hierbei unpatched/nicht aktuelle Software oder unachtsam heruntergeladene Dateien.
            ***[Schutz] Wie kann man sich schützen?
             Um sich vor Malware-Angriffen zu schützen, sollte man Vorsichtsmaßnahmen bei der Installation von Software oder dem Herunterladen von Dateien treffen. Regelmäßige Updates für Betriebssysteme und Antivirus-Software können ebenfalls helfen, bekannte Bedrohungen zu erkennen und zu verhindern. ->Divert1
            ***[Zurück] ->Divert1
        **[Zurück]
            Zurück -> Divert1
 ...
 * [SQL-Injection] Erzähl mir mehr über SQL-Injection.
    SQL-Injection Attacken sind Versuche, durch das Einschleusen von Schadcode in eine Datenbank Schaden anzurichten oder Daten zu stehlen.
        **[Beispiele] Wie funktioniert das genau?
            SQL-Injection-Angriffe nutzen Schwachstellen in Datenbanken, um Schaden anzurichten oder Daten zu stehlen. Der Angreifer schleust hierbei Schadcode in Anfragen an die Datenbank ein, der dann ausgeführt wird. Einfallstore sind hierbei unsichere Programmierung von Datenbank-Anwendungen.
            ***[Schutz] Wie kann man sich schützen?
             Um sich gegen SQL-Injection-Angriffe zu schützen, sollte man sicherstellen, dass Datenbank-Anwendungen sicher programmiert werden. Hierbei kann es hilfreich sein, auf bewährte Sicherheitspraktiken und -technologien zurückzugreifen. ->Divert1
            ***[Zurück] ->Divert1
        **[Zurück]
            Zurück -> Divert1
