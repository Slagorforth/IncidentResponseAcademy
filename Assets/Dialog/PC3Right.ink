PC3: Was möchten sie tun? (Bediene die Button per Maus)
...
== Divert1 ==
 ...
 + [Isolate] Isolate
    Das Isolieren des PCs sorgt für eine Abkapslung vom Netzwerk wodurch kein Zugang zum Internet oder zu jeglichen Servern möglich ist. Möchten Sie fortfahren?
        ++[Ja] 
            Der PC wurde aufgrund verdächtigen Logfiles isoliert. Zur weiteren Überprüfung wurde ein Ticket erstellt. Code: 3 
                +++[Leave] ->EndPart
        ++[Nein] -> Divert1
 + [Shutdown] Shutdown
